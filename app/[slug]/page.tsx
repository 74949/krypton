...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) { const { slug } = await params; if (!(slug in pages) || slug === "home") notFound(); return <AronxxTechPage page={slug as PageKey} />; }
